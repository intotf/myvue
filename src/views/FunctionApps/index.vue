...
<div>
  ...
  <el-table border :data="pageData" style="width: 100%" :default-sort = "{prop: 'createTime', order: 'descending'}" @sort-change="handlerSort">
    ...
    <el-table-column prop="appName" label="应用名称" sortable width="180" />
    <el-table-column prop="functionName" label="功能名称" sortable />
    <el-table-column prop="appId" label="appId" sortable width="180" />
    <el-table-column prop="appSecret" label="App密钥" sortable width="180" />
    ...
    <el-table-column prop="appState" label="状态" sortable />
